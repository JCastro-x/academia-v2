...
export default function AppLayout() {
  ...
  const navItems = [
    ...
    { path: 'schedule', label: 'Plan Semestral', icon: 'M9 5H7a2 2 0 00-2 2v14a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01' },
    { type: 'divider' },
    ...
    { path: 'topics', label: 'Temas', icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' },
    { type: 'divider' },
    { path: 'habits', label: 'Hábitos', icon: 'M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15' },
  ...
  return (
    <div className="h-screen flex flex-col bg-gray-50 dark:bg-[var(--dm-bg)] overflow-hidden">
      ...
      <div className="flex relative flex-1 min-h-0 overflow-visible">
        ...
        {/* Sidebar */}
        <aside
          className={`bg-white dark:bg-[var(--dm-surface)] border-r border-gray-200 dark:border-[var(--dm-border)] transition-all duration-300 fixed top-0 md:sticky md:top-0 z-50 h-full overflow-y-auto ${
                ...
                if (item.type === 'divider') {
                  return (
                    <li key={`divider-${index}`} className="py-2">
                      <div className={`border-t border-gray-200 dark:border-[var(--dm-border)] ${isSidebarCollapsed ? 'mx-2' : ''}`} />
                    </li>
                  )
                }
      ...
      <nav className="fixed inset-x-0 bottom-0 z-[60] border-t border-[var(--dm-border)] bg-[var(--dm-surface)]/95 px-2 py-2 shadow-[0_-10px_30px_rgba(15,23,42,0.08)] backdrop-blur-md md:hidden">
        <div className="mx-auto flex max-w-md items-center justify-between gap-1">
          ...
          <button
            ...
            className="flex h-16 w-16 items-center justify-center rounded-full bg-[var(--color-primary)] text-white shadow-lg transition-transform hover:scale-105 active:scale-95"
            style={{ color: '#000000' }}
          >
