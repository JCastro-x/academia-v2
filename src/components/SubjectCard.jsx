...
export default function SubjectCard({ subject, onEdit, onDelete, onViewGrades, onViewTopics }) {
  ...
  return (
    ...
    >
      ...
      <div className="mt-4 flex min-w-0 gap-2">
        ...
        <button
          onClick={(e) => { e.stopPropagation(); onViewTopics && onViewTopics(subject) }}
          className="min-w-0 flex-1 interactive bg-[color-mix(in_srgb,purple_12%,transparent)] text-purple-600 py-2 px-2 rounded-lg hover:bg-[color-mix(in_srgb,purple_20%,transparent)] dark:bg-[color-mix(in_srgb,purple_12%,transparent)] dark:text-purple-300 dark:hover:bg-[color-mix(in_srgb,purple_20%,transparent)]"
          title="Ver temas"
        >
          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
