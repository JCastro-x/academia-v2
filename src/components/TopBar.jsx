...
export default function TopBar({ onOpenClassModal, onOpenQuickAdd }) {
  ...
  return (
    <header className="bg-white dark:bg-[var(--dm-surface)] border-b border-gray-200 dark:border-[var(--dm-border)] px-4 py-3 flex items-center justify-between">
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="hidden md:flex items-center gap-1">
          ...
          <button
            disabled
            title="Próximamente"
            className="px-3 py-1.5 text-sm bg-gray-100 dark:bg-[var(--dm-border)] text-gray-400 dark:text-[var(--dm-text-muted)] rounded-lg cursor-not-allowed"
          >
            Examen
          </button>
        </div>
